                     ...
                     <div class="col-lg-6 col-md-8 u-s-m-b-30">
                         <div class="l-f-o">
                             <div class="l-f-o__pad-box">
                                 ...
                                 <form method="POST" action="<?= base_url('front/login'); ?>" class="l-f-o__form">

                                     <div class="u-s-m-b-30">

                                         <label class="gl-label" for="login-email">NPM *</label>

                                         <input class="input-text input-text--primary-style" type="text" id="login-email" placeholder="NPM" name="npm">
                                     </div>
                                     <div class="u-s-m-b-30">

                                         <label class="gl-label" for="login-password">PASSWORD *</label>

                                         <input class="input-text input-text--primary-style" type="password" id="login-password" placeholder="Password" name="password">
                                     </div>
                                     <div class="u-s-m-b-20">

                                         <button class="shop-now-link btn--e-brand" style="width: 100%;" type="submit">LOGIN</button>
                                     </div>
                                     <!-- <div class="u-s-m-b-20">
                                         <center>
                                     ...
                                     <!-- <h5 class="gl-h3">Belum Punya Akun?</h5> -->

                                     <div class="u-s-m-b-15">

                                         <a class="l-f-o__create-link btn--e-transparent-brand-b-2" href="<?= base_url('Home/registrasi') ?>">Buat Akun</a>
                                     </div>
                                 </form>
                             </div>
                         </div>
