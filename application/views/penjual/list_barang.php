                ...
                <div class="box box-info">
                    <div class='box-header  with-border'>
                        ...
                        <div class="pull-right">
                            <?php
                            echo anchor('Produk/tambahProduk', 'Tambah data', array('class' => 'btn btn-success'))
                            ?>
                        </div>
                    </div>
                    <div class="box-body">
                            ...
                            <tbody>
                                ...
                                foreach ($param as $produk) { ?>
                                    <tr>
                                        ...
                                        <td>Rp.<?php echo number_format($produk->harga_jual); ?></td>
                                        <td><?php echo $produk->stok; ?></td>
                                        <td><?php
                                            echo anchor(site_url('Produk/edit/' . $produk->id_produk), '<i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;&nbsp;Edit', array('title' => 'edit', 'class' => 'btn btn-sm btn-warning'));
                                            echo '&nbsp';
                                            echo anchor(site_url('Produk/hapus/' . $produk->id_produk), '<i class="fa fa-trash fa-lg"></i>&nbsp;&nbsp;Hapus', 'title="delete" class="btn btn-sm btn-danger "');
                                            ?>
                                        </td>
