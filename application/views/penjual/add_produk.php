        ...
        <div class="row">
            <div class='col-xs-12'>
                <div class='box box-primary'>
                    ...
                    <div class="box-body">
                        <?php echo form_open_multipart('Produk/insert', array('role' => "form", 'id' => "myForm", 'data-toggle' => "validator")); ?>
                        <div class="form-group">
                            <label for="nama_barang" class="control-label">Nama Produk</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="nama" id="nama_barang" data-error="Nama Barang harus diisi" placeholder="nama barang" value="" required />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="deskripsi" id="dskripsi" data-error="Nama Barang harus diisi" placeholder="Deskripsi" />
                                <span class=" input-group-addon">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" name="stok" id="stok" data-error="stok harus di isi" class="form-control" value="0" placeholder="Stok Produk" required>
                                <span class="input-group-addon">
